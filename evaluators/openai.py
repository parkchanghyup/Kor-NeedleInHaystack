...
class OpenAIEvaluator(Evaluator):
    ...
    def evaluate_response(self, response: str) -> int:
        ...
        # 한국어 평가 프롬프트
        eval_template = """당신은 전문 평가자입니다. 예측 답변과 참조 답변을 비교하세요.

질문: {input}

참조 답변 (Needle): {reference}
...
숫자 점수만 제공하세요 (1, 3, 5, 7, 10)."""
        ...
        prompt = PromptTemplate(
            ...
            input_variables=["input", "reference", "prediction", "criteria"]
        )
        ...
        result = chain.invoke({
            ...
            "prediction": response,
            "criteria": self.CRITERIA["accuracy"]
        })
