    ...
    <div className="glass-panel" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-glass)', paddingBottom: '1rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <h2 className="mono" style={{ fontSize: '1.2rem', margin: 0, color: '#fff', letterSpacing: '0.05em' }}>
            TEST HISTORY
          </h2>
                ...
                <div className="history-card__body">
                  <div className="history-card__top">
                    <div className="history-card__model">
                      <span className="mono" style={{ color: '#fff', fontSize: '1rem', fontWeight: 700 }}>
                        {item.model_name}
                      </span>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                      ...
                      {deleteConfirm === item.id ? (
                        ...
                        <motion.button
                          ...
                          whileHover={{ scale: 1.1, color: '#f82572' }}
                          whileTap={{ scale: 0.95 }}
                          title="삭제"
                        >
                          <Trash2 size={15} />
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-glass)', paddingBottom: '1rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            <h2 className="mono" style={{ fontSize: '1.2rem', color: '#fff', margin: 0 }}>{config?.model_name}</h2>
            <span className="mono" style={{ color: 'var(--text-muted)', fontSize: '0.78rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
        <motion.div
          className="glass-panel"
          style={{ padding: '1.2rem', background: 'rgba(0,0,0,0.4)', borderLeft: '4px solid var(--accent-primary)' }}
        ...
        >
          ...
          <div style={{ fontSize: '1.8rem', fontWeight: 700, color: '#fff', marginTop: '0.3rem' }}>
        ...
        <motion.div
          className="glass-panel"
          style={{ padding: '1.2rem', background: 'rgba(0,0,0,0.4)', borderLeft: `4px solid ${getAccuracyColor(accuracy)}` }}
...
function ConfigCard({ label, value, sublabel }) {
  return (
    <div style={{
      ...
      <div style={{ color: '#fff', fontSize: '0.85rem', fontWeight: 600, marginTop: '0.2rem' }}>
        {value}
      </div>
      {sublabel && (
